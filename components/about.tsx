...
export function About() {
  ...
  const defaultInfo = {
    title: "소개",
    subtitle: "데이터와 이야기를 통해 도시를 읽어내는 도시계획 및 부동산전공자입니다",
    background: {"image":"","video":"","color":"#f59494","opacity":0.1},
    experienceCards: [{"icon":"graduation","title":"단국대학교","period":"2024~","description":"도시계획부동산학부 재학중"},{"icon":"award","title":"공인중개사","period":"2025년 7월~","description":"내년 동차 합격 목표로 준비중"},{"icon":"award","title":"투자자산운용사","period":"2025년 11월~","description":"내년 4월 합격 목표로 준비중"},{"icon":"briefcase","title":"기린렌탈","period":"2025년 6월~8월","description":"인턴직"},{"icon":"trophy","title":"GTQ","period":"2024년 1월","description":"포토샵 자격증"},{"icon":"trophy","title":"TESAT 3급","period":"2024년 7월","description":"경제 이해력 시험"},{"icon":"trophy","title":"한국사능력검정시험 3급","period":"2022","description":"한국사 시험"},{"icon":"briefcase","title":"상현하이텍","period":"2025 1월~2월","description":"인턴직"},{"icon":"trophy","title":"MOS","period":"2022","description":"문서,엑셀 국제자격증"}],
    skills: [{"icon":"code","title":"R 기반 데이터 처리 및 통계 분석","description":"tidyverse, ggplot2, dplyr 등 활용한 데이터 전처리 및 패턴 도출 능력."},{"icon":"database","title":"도시 공간 분석","description":"도시 구조 변화, 상권 분석, 공원 접근성 등 다양한 도시 공간 현상을 해석도시 구조 변화, 상권 분석, 공원 접근성 등 다양한 도시 공간 현상을 해석"},{"icon":"barChart","title":"모빌리티 데이터 분석","description":"따릉이·지하철 등 공공데이터를 활용한 수요 분석, OD 분석, 시각화 경험"},{"icon":"brain","title":"정책 평가 및 개선 제안 능력","description":"복잡한 정책 구조를 이해하고 문제점을 진단한 뒤 현실성 있는 대안을 제시할 수 있는 역량"},{"icon":"cpu","title":"AI·빅데이터 기반 도시문제 접근 능력","description":"머신러닝과 빅데이터 분석을 활용해 행정·도시 문제를 기술적으로 해석하고 예측하는 능력"},{"icon":"brain","title":"지역성·도시 맥락 해석 능력","description":"도시의 역사·문화·정체성을 분석하여 지역 특성을 반영한 계획 방향을 제시할 수 있는 능력"}],
    storyTitle: "나의 이야기",
    story: ["도시를 바라보는 제 시선은 늘 “왜 이런 모습이 되었을까?”라는 질문에서 시작됩니다. 사람들은 어떤 이유로 특정 시간과 장소에 몰리고, 어떤 공간은 활기를 띠고 또 어떤 공간은 빠르게 쇠퇴하는지, 그리고 도시정책은 어떻게 한 도시의 표정을 바꿔놓는지를 궁금해하며 관찰해왔습니다. 그래서 저는 도시를 단순히 ‘구조물의 집합’이 아닌, 수많은 데이터·관계·역사가 층층이 쌓여 형성된 복합적인 생명체로 이해하려고 노력해 왔습니다.\n\n도시의 움직임을 더 정확히 이해해 보기 위해 저는 데이터를 다루는 법을 먼저 익혔습니다. 서울의 공공자전거와 지하철 승하차 데이터, 한강공원 주차장 이용량 등 다양한 도시 데이터를 분석하며 시간대별·공간별 수요 패턴을 읽는 능력을 키웠습니다. 이를 통해 도시의 흐름은 결코 우연이 아니라, 생활권 구조·교통망 배치·활동 밀도 등 복합적인 요인의 결과임을 몸으로 느꼈습니다. 또한 이러한 정량적 분석 경험은 도시문제를 ‘감’이 아니라 근거로 이해하고 설명할 수 있는 기반이 되었습니다.\n\n데이터에서 한 발 더 나아가, 저는 도시가 실제로 어떻게 구성되고 변화하는지 공간적으로 살펴보려 노력했습니다. 커낼워크 상권 분석에서는 동선의 단절, 접근성 부족, 이용자 특성 등 공간구조가 상권의 성패를 좌우하는 과정을 경험했고, 광주 도시계획사 연구에서는 도시의 역사가 공간에 어떻게 새겨지고, 중심지의 이동이 시민들의 활동과 정체성에 어떤 영향을 미쳐왔는지 배웠습니다. 이 두 경험은 도시를 이해할 때 역사·문화·공간이 서로 연결되어 있다는 사실을 깊이 체감하게 했습니다.\n\n정책의 관점에서도 도시를 바라보고 싶었습니다. 주택정책 프로젝트에서는 청년·신혼부부·고령가구의 주거 실태와 특별공급제도의 구조적 한계를 분석하며, 제도가 도시의 삶을 어떻게 직접적으로 변화시키는지 이해했습니다. 행정구역 개편 프로젝트에서는 AI와 빅데이터를 활용해 행정 문제를 분석해보며 기술과 도시가 만나는 새로운 가능성을 보았습니다. 환경관리 프로젝트에서 다룬 갠지스강 오염 문제는 도시·환경·사회가 분리될 수 없다는 점을 다시 한 번 깨닫게 해주었습니다.\n\n이처럼 서로 다른 주제의 프로젝트들이었지만, 결국 하나의 흐름으로 이어졌습니다. 도시를 이해한다는 것은 특정 현상을 따로 떼어 보는 것이 아니라, 데이터·공간·정책·환경·기술이 맞물리며 만들어내는 복잡한 구조를 통합적으로 해석하는 일이라는 깨달음입니다. 그래서 저는 앞으로도 다양한 관점에서 도시를 탐구하고, 문제뿐 아니라 잠재된 가능성까지 발견하며, 더 나은 방향을 제안할 수 있는 도시계획가로 성장하고자 합니다.\n\n도시는 늘 변화하고, 그 변화 속에서 사람들의 삶 또한 끊임없이 다시 구성됩니다. 저는 그 변화를 올바르게 이해하고, 더 나은 도시를 만드는 데 기여할 수 있는 사람이 되고 싶습니다.\n"],
    storyImage: "/uploads/about-image-1765009692668.jpg",
    hobbies: ["📚 독서","☕ 카페 투어","🎨 전시회 관람","✈️ 여행","🎮 게임","🎬 영화 감상","🎵 음악 감상","🎭 연극 관람","🎪 공연 관람","🚴 자전거","✍️ 글쓰기"]
  }
